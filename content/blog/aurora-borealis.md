...
{{ figure(src="/img/aurora-1.webp", alt="NOAA Space Weather Prediction Center | G-Kp", caption="2023-07-12: G is NOAA Geomagnetic Storm Index (0.5) | Kp is Planetary K Index (0-9)", width="750px") }}

{{ figure(src="/img/aurora-2.webp", alt="Aurora Forecast for 2023-09-18", caption="2023-09-18: Aurora Borealis Forecast", width="750px") }}
